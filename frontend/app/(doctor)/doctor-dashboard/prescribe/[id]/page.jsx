    ...
    <div className="p-6 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-gray-50 p-5 rounded-xl border h-fit">
        ...
        <p className="text-gray-600 mt-1">
          Age: {appointment.patientInfo?.age || "N/A"} | Gender:{" "}
      ...
      <form
        ...
        className="md:col-span-2 bg-white p-6 rounded-xl border shadow-sm space-y-6"
      >
        ...
        <div>
          ...
          {medicines.map((med, idx) => (
            <div
              key={idx}
              className="grid grid-cols-1 sm:grid-cols-4 gap-2 mb-2 border p-2 rounded-lg bg-gray-50"
            >
              <input
                type="text"
